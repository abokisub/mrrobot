...
class PaymentController extends Controller
{
    ...
    $secret = "c095833106da5b4dcfaa0ca1329e491f48408f1ba795fbeb9f1b76168950ae02d7afff6b60f55e7fc4b996b259abdb6c3464ed30b881262fe9af64f8";
...
{ 
  ...
  public function KudaByAdex(Request $request){
...
public function WithdrawKuda()
{
    ...
    foreach ($records as $adex_record) {
        dispatch(new ProcessKudaWithdrawal($adex_record));
    }
}
