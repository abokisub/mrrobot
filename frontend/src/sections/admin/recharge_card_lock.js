...
// ----------------------------------------------------------------------
TheRechargeCardLock.propTypes = {
    discount: PropTypes.object,
  };
export default function TheRechargeCardLock({ discount}) {
  ...
  useEffect(() => {
    if (discount && Array.isArray(discount) && discount.length >= 4) {
      ...
      reset({
        mtn: mtn?.recharge_card === 1 || mtn?.recharge_card === true,
        glo: glo?.recharge_card === 1 || glo?.recharge_card === true,
        airtel: airtel?.recharge_card === 1 || airtel?.recharge_card === true,
        mobile: mobile?.recharge_card === 1 || mobile?.recharge_card === true,
      });
    }
  ...
  const onSubmit = async (data) => {
    try {
      await axios.post(`/api/recharge_card_lock/${AccessToken}/secure`,data)
